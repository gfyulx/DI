...
import com.gfyulx.DI.flink.core.Main;
...
//                "CREATE TABLE MyResult(channel STRING, pv INT) WITH ( type='mysql', url='jdbc:mysql://172.16.8.104:3306/test?charset=utf8',userName='gfyulx.DI',password='abc123', tableName='pv');" +
//               "create table sideTable(channel String, xccount int, PRIMARY KEY (channel),PERIOD FOR SYSTEM_TIME) WITH ( type='mysql', url='jdbc:mysql://172.16.8.104:3306/test?charset=utf8',userName='gfyulx.DI',password='abc123', tableName='sidetest');" +
...
//                "insert into MyResult select channel from MyTable group by channel";
    ...
    public void testRunHbaseSideTable() throws Exception {
            String sql = "CREATE TABLE MyTable ( name string, channel STRING, pv INT, xctime bigint, CHARACTER_LENGTH(channel) AS timeLeng) " +
                    ...
                    "url = 'jdbc:mysql://172.16.8.104:3306/test?charset=utf8',userName = 'gfyulx.DI',password = 'abc123',tableName = 'pv2'," +
    ...
    public void test(String sql) throws Exception {
        ...
        paramList.add("/opt/gfyulx.DI/flinkplugin");
