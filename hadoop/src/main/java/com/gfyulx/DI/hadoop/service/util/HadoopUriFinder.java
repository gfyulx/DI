...
public class HadoopUriFinder {

    public static String getJarVersion(final File jarFile) throws IOException {
    ...
    public static URI getFixedUri(final URI fileUri) throws URISyntaxException, IOException {
     ...
     */
    public static URI getFixedUri(final FileSystem fs, final URI fileUri) throws URISyntaxException {
